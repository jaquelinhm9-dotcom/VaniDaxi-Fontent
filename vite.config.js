...
const repairAppFixed = () => ({
  ...
  transform(code, id) {
    ...
    next = next.replace("import{loadCommercialState,syncFavorites,syncCart,syncAddress,createCommercialOrder}from'./commercialApi.js'", "import{loadCommercialState,syncFavorites,syncCart,syncAddress,createCommercialOrder,loadNotifications}from'./commercialApi.js';import{createStripeCheckout}from'./stripeCheckout.js'")
